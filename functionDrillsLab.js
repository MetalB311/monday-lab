...
//CODE HERE
function theEliminator (player, lost){
...
function emailCheck (emailParam){
  ...
  }else return ('must provid a valid email address')
}
console.log(emailCheck('john@gmail.com'))
...
//CODE HERE
function howManyICanBuy1(galleon){
  return(galleon / 3)
  }
  console.log(howManyICanBuy1(16))
...
console.log(arrayIncreasing(sampleArray))
